...
static void render_main_oled(void) {
    ...
    if (highest_layer == _QWERTY) {
        ...
        oled_write_char((highest_layer == _SYMBOL) ? OFF_ON_1 : OFF_OFF_1, false);
    }
    if (highest_layer == _SYMBOL) {
    ...
    if (highest_layer == _QWERTY) {
        ...
        oled_write_char((highest_layer == _SYMBOL) ? OFF_ON_2 : OFF_OFF_2, false);
    }
    if (highest_layer == _SYMBOL) {

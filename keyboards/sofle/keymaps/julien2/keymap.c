...
[_SYMBOL] = LAYOUT(
  ...
  _______, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, RGB_MOD,                          _______, _______, _______, _______, _______, KC_NUBS,
  _______, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, RGB_RMOD, _______,       _______, _______, _______, _______, _______, _______, KC_BSLS,
...
[_NAVIGATION] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                      KC_PGDN, KC_LEFT,    KC_DOWN, KC_RGHT,    KC_APP,  _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, _SYMBOL, _NAVIGATION, _RGB);
}

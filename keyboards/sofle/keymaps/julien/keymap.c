...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EQL,  KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR,     _______,       _______, KC_LBRC,     KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______,
                    _______, _______, _______, TO(_QWERTY), _______,       _______, TO(_ADJUST), _______, _______, _______
),
/* RAISE
 * ╭──────┬──────┬──────┬──────┬──────┬──────╮                         ╭──────┬──────┬──────┬──────┬──────┬──────╮
 * │      │      │      │      │      │      ├───────╮    E    ╭───────┤      │      │      │      │      │PrntSc│
...
[_RAISE] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_WH_D,    _______, XXXXXXX,     C(KC_LEFT), XXXXXXX, C(KC_RGHT), XXXXXXX, _______,
                    _______, _______, _______,TO(_ADJUST), _______,    _______, TO(_QWERTY), _______,    _______, _______
),
/* ADJUST
 * ╭──────┬──────┬──────┬──────┬──────┬──────╮                         ╭──────┬──────┬──────┬──────┬──────┬──────╮
 * │Toggle│      │      │      │      │      ├───────╮    E    ╭───────┤      │      │      │      │      │      │
...
[_ADJUST] = LAYOUT(
  ...
  XXXXXXX, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX, XXXXXXX,     RGB_HUD,        RGB_MOD,  XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                    XXXXXXX, XXXXXXX, XXXXXXX, TO(_QWERTY), XXXXXXX,        XXXXXXX,  TO(_QWERTY), XXXXXXX, XXXXXXX, XXXXXXX
)
};
